...
if(comportement_control_CONFIG_INCLUDED)
  return()
endif()
set(comportement_control_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(comportement_control_SOURCE_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/src/comportement_control)
  set(comportement_control_DEVEL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/devel_isolated/comportement_control)
  ...
  set(comportement_control_INSTALL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/install_isolated)
  set(comportement_control_PREFIX ${comportement_control_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'comportement_control' is deprecated")
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${comportement_control_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'comportement_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jennie/irecheck/iReCheck/qtrobot_ws/src/comportement_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(comportement_control_LIBRARY_DIRS ${lib_path})
      list(APPEND comportement_control_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'comportement_control'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND comportement_control_LIBRARIES ${lib})
    endif()
  endif()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 comportement_control_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${comportement_control_dep}_FOUND)
      find_package(${comportement_control_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${comportement_control_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(comportement_control_INCLUDE_DIRS ${${comportement_control_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(comportement_control_LIBRARIES ${comportement_control_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${comportement_control_dep}_LIBRARIES})
  _list_append_deduplicate(comportement_control_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(comportement_control_LIBRARIES ${comportement_control_LIBRARIES})

  _list_append_unique(comportement_control_LIBRARY_DIRS ${${comportement_control_dep}_LIBRARY_DIRS})
