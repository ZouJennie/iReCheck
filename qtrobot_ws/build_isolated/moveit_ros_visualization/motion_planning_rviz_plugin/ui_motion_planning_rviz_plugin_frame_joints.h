...
public:
    ...
    {
        MotionPlanningFrameJointsUI->setWindowTitle(QApplication::translate("MotionPlanningFrameJointsUI", "Form", 0));
        joints_view_label_->setText(QApplication::translate("MotionPlanningFrameJointsUI", "Group joints:", 0));
        label->setText(QApplication::translate("MotionPlanningFrameJointsUI", "Nullspace exploration:", 0));
    } // retranslateUi
