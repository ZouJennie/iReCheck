...
if(qt_control_CONFIG_INCLUDED)
  return()
endif()
set(qt_control_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(qt_control_SOURCE_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/src/qt_control)
  set(qt_control_DEVEL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/devel_isolated/qt_control)
  set(qt_control_INSTALL_PREFIX "")
  set(qt_control_PREFIX ${qt_control_DEVEL_PREFIX})
else()
  set(qt_control_SOURCE_PREFIX "")
  set(qt_control_DEVEL_PREFIX "")
  set(qt_control_INSTALL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/install_isolated)
  set(qt_control_PREFIX ${qt_control_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'qt_control' is deprecated")
...
set(qt_control_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(qt_control_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${qt_control_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'qt_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'qt_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(qt_control_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND qt_control_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND qt_control_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT qt_control_NUM_DUMMY_TARGETS)
      set(qt_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::qt_control::wrapped-linker-option${qt_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR qt_control_NUM_DUMMY_TARGETS "${qt_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::qt_control::wrapped-linker-option${qt_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND qt_control_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(qt_control_LIBRARY_DIRS ${lib_path})
      list(APPEND qt_control_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'qt_control'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND qt_control_LIBRARIES ${lib})
    endif()
  endif()
...
set(qt_control_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${qt_control_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 qt_control_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${qt_control_dep}_FOUND)
      find_package(${qt_control_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${qt_control_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(qt_control_INCLUDE_DIRS ${${qt_control_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(qt_control_LIBRARIES ${qt_control_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${qt_control_dep}_LIBRARIES})
  _list_append_deduplicate(qt_control_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(qt_control_LIBRARIES ${qt_control_LIBRARIES})

  _list_append_unique(qt_control_LIBRARY_DIRS ${${qt_control_dep}_LIBRARY_DIRS})
  list(APPEND qt_control_EXPORTED_TARGETS ${${qt_control_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${qt_control_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
