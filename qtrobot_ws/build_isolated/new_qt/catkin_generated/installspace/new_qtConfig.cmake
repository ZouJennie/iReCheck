...
if(new_qt_CONFIG_INCLUDED)
  return()
endif()
set(new_qt_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(new_qt_SOURCE_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/src/new_qt)
  set(new_qt_DEVEL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/devel_isolated/new_qt)
  set(new_qt_INSTALL_PREFIX "")
  set(new_qt_PREFIX ${new_qt_DEVEL_PREFIX})
else()
  set(new_qt_SOURCE_PREFIX "")
  set(new_qt_DEVEL_PREFIX "")
  set(new_qt_INSTALL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/install_isolated)
  set(new_qt_PREFIX ${new_qt_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'new_qt' is deprecated")
...
set(new_qt_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(new_qt_INCLUDE_DIRS "")
  set(_include_dirs "")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zou <jianlingzou93@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${new_qt_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'new_qt' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'new_qt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(new_qt_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND new_qt_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND new_qt_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT new_qt_NUM_DUMMY_TARGETS)
      set(new_qt_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::new_qt::wrapped-linker-option${new_qt_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR new_qt_NUM_DUMMY_TARGETS "${new_qt_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::new_qt::wrapped-linker-option${new_qt_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND new_qt_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(new_qt_LIBRARY_DIRS ${lib_path})
      list(APPEND new_qt_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'new_qt'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND new_qt_LIBRARIES ${lib})
    endif()
  endif()
...
set(new_qt_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${new_qt_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 new_qt_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${new_qt_dep}_FOUND)
      find_package(${new_qt_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${new_qt_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(new_qt_INCLUDE_DIRS ${${new_qt_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(new_qt_LIBRARIES ${new_qt_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${new_qt_dep}_LIBRARIES})
  _list_append_deduplicate(new_qt_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(new_qt_LIBRARIES ${new_qt_LIBRARIES})

  _list_append_unique(new_qt_LIBRARY_DIRS ${${new_qt_dep}_LIBRARY_DIRS})
  list(APPEND new_qt_EXPORTED_TARGETS ${${new_qt_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${new_qt_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
