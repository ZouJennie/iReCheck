...
if(left_arm_config_CONFIG_INCLUDED)
  return()
endif()
set(left_arm_config_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(left_arm_config_SOURCE_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/src/left_arm_config)
  set(left_arm_config_DEVEL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/devel_isolated/left_arm_config)
  set(left_arm_config_INSTALL_PREFIX "")
  set(left_arm_config_PREFIX ${left_arm_config_DEVEL_PREFIX})
else()
  set(left_arm_config_SOURCE_PREFIX "")
  set(left_arm_config_DEVEL_PREFIX "")
  set(left_arm_config_INSTALL_PREFIX /home/jennie/irecheck/iReCheck/qtrobot_ws/install_isolated)
  set(left_arm_config_PREFIX ${left_arm_config_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'left_arm_config' is deprecated")
...
set(left_arm_config_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(left_arm_config_INCLUDE_DIRS "")
  set(_include_dirs "")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Jennie <zjl93128@hotmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${left_arm_config_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'left_arm_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'left_arm_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(left_arm_config_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND left_arm_config_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND left_arm_config_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT left_arm_config_NUM_DUMMY_TARGETS)
      set(left_arm_config_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::left_arm_config::wrapped-linker-option${left_arm_config_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR left_arm_config_NUM_DUMMY_TARGETS "${left_arm_config_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::left_arm_config::wrapped-linker-option${left_arm_config_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND left_arm_config_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(left_arm_config_LIBRARY_DIRS ${lib_path})
      list(APPEND left_arm_config_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'left_arm_config'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND left_arm_config_LIBRARIES ${lib})
    endif()
  endif()
...
set(left_arm_config_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${left_arm_config_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 left_arm_config_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${left_arm_config_dep}_FOUND)
      find_package(${left_arm_config_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${left_arm_config_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(left_arm_config_INCLUDE_DIRS ${${left_arm_config_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(left_arm_config_LIBRARIES ${left_arm_config_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${left_arm_config_dep}_LIBRARIES})
  _list_append_deduplicate(left_arm_config_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(left_arm_config_LIBRARIES ${left_arm_config_LIBRARIES})

  _list_append_unique(left_arm_config_LIBRARY_DIRS ${${left_arm_config_dep}_LIBRARY_DIRS})
  list(APPEND left_arm_config_EXPORTED_TARGETS ${${left_arm_config_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${left_arm_config_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
