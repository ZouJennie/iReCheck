...
struct JointInfo_
{
  ...
  _confidence_type confidence;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _real_type;
  _real_type real;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _projection_type;
