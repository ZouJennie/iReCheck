...
struct Faces_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::qt_nuitrack_app::FaceInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::qt_nuitrack_app::FaceInfo_<ContainerAllocator> >::other >  _faces_type;
  _faces_type faces;
