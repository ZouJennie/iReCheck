...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.right_projection))
      length = len(self.right_real)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.right_real))
      _x = self
      buff.write(_get_struct_Bi().pack(_x.right_click, _x.right_pressure))
      length = len(self.left_projection)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.left_projection))
      length = len(self.left_real)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.left_real))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.right_projection = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.right_real = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 5
      ...
      self.left_projection = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.left_real = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 5
