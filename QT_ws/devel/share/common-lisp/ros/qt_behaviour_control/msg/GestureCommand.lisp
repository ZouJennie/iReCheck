...
(cl:in-package qt_behaviour_control-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <GestureCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GestureCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_behaviour_control-msg:<GestureCommand> is deprecated: use qt_behaviour_control-msg:GestureCommand instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <GestureCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_behaviour_control-msg:name-val is deprecated.  Use qt_behaviour_control-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <GestureCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_behaviour_control-msg:speed-val is deprecated.  Use qt_behaviour_control-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GestureCommand>)))
  ...
  "qt_behaviour_control/GestureCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GestureCommand)))
  "Returns string type for a message object of type 'GestureCommand"
  "qt_behaviour_control/GestureCommand")
